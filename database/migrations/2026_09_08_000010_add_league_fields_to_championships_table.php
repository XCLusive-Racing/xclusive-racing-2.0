...
// league_id null) to also carry external leagues' championships, rather than
// forking a second table — the standings/points logic already on this model
// keeps working for both. New rules live in `settings`, not new columns.
