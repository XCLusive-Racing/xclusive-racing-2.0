...
class AccServerConfigService implements ServerConfigGenerator
{
    ...
    {
        // A waitlisted driver doesn't get a seat on the actual race server -- only
        // once they're promoted (a spot opens up, computed live by
        // Race::isRegistrationWaitlisted()) does the next scheduled config push pick
        // them up here. They can still practice in the meantime -- see
