...
<main class="events-page xcl-page pb-5 px-3" x-data="eventsFilter()">
    ...
    <div class="container-xl" style="position:relative;z-index:1">
        ...
        <div x-show="platform === null">
            ...
            @guest
            <div class="events-cta-banner rounded-3 p-5 text-white text-center">
                ...
                <div style="position:relative;z-index:1">
                    ...
                    <p class="mb-4 fs-5" style="color:rgba(255,255,255,.8)">Sign up now to access all events and track your ELO rating</p>
                    <a href="{{ route('register') }}" class="btn btn-light fw-black text-uppercase px-5 py-3 text-xcl-purple">
                        JOIN NOW →
                    </a>
                </div>
            </div>
