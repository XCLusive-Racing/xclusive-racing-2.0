...
<div class="mb-4" data-image-upload>
    ...
    <div data-image-upload-zone
        ...
        <div data-image-upload-placeholder
             class="d-flex flex-column align-items-center justify-content-center py-4 text-secondary"
             style="font-size:.85rem;{{ $imageUploadUrl ? 'display:none' : '' }}">
        ...
        <img data-image-upload-preview
             src="{{ $imageUploadUrl }}"
             style="width:100%;max-height:200px;object-fit:cover;display:{{ $imageUploadUrl ? 'block' : 'none' }}">
    </div>
    <input type="file" name="{{ $name }}" accept="image/*" data-image-upload-input class="d-none">
    @error($name)
