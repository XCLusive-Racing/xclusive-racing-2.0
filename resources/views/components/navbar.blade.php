...
<nav class="navbar navbar-xcl navbar-expand-xcl fixed-top">
    ...
    <div class="container-fluid px-5 align-content-center">
        ...
        <div class="xcl-mobile-nav-row d-xcl-none">
        ...
        <div class="collapse navbar-collapse">
            ...
            @auth
            <div class="d-flex d-xcl-none align-items-center gap-2 py-2 mb-1 border-bottom border-secondary-subtle">
            ...
            {{-- Nav links --}}
            <ul class="navbar-nav mx-auto gap-xcl-4">

                <li class="nav-item d-xcl-none">
                ...
                <li class="nav-item position-relative" data-dropdown>
                    ...
                    <ul class="xcl-dropdown" data-dropdown-menu
                        style="display:none;opacity:0;transform:translateY(4px);transition:opacity .15s ease,transform .15s ease">
                        <li class="d-xcl-none"><a class="xcl-dropdown-item" href="{{ route('news.index') }}">OVERVIEW</a></li>
            ...
            <div class="d-none d-xcl-flex align-items-center gap-3">

                <a href="https://paypal.me/xcl789" target="_blank" rel="noopener"
                   class="btn btn-sm fw-bold text-white d-none d-xcl-inline-flex align-items-center gap-2 bg-xcl-purple">
                ...
                @auth
                    @if(auth()->user()->canAccessAdminPanel())
                        <a href="{{ route(auth()->user()->adminLandingRoute()) }}"
                           class="btn btn-sm fw-bold text-uppercase text-white d-none d-xcl-inline-flex bg-xcl-purple">
                            ADMIN
                        </a>
                    @endif
