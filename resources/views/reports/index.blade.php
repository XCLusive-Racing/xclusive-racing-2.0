...
<main class="xcl-page pb-5 px-3 bg-light">
    ...
    <div class="container" style="max-width:900px;position:relative;z-index:1">
        ...
        <x-sr-scale class="bg-white rounded-3 shadow-sm p-4 mb-4" heading="XCL Safety Rating" />
            ...
            <div class="col-lg-5">
                <div class="bg-white rounded-3 shadow-sm overflow-hidden">
                    ...
                    <form method="POST" action="{{ route('reports.store') }}" class="p-4">
                        ...
                        @include('reports._incident-fields')
                            ...
                            <div class="px-4 py-3 border-bottom">
                                ...
                                <div class="d-flex gap-2 mt-2">
                                    <a href="{{ route('reports.edit', $report) }}"
                                       class="btn btn-sm fw-bold" style="font-size:.72rem;background:#f3f0ff;color:#7c3aed;border:1px solid #ddd6fe">
                                        Edit
                                    </a>
                                    <form method="POST" action="{{ route('reports.retract', $report) }}"
                                          onsubmit="return confirm('Retract this report? Stewards will no longer review it.')">
                                        @csrf
                                        <button type="submit" class="btn btn-sm fw-bold" style="font-size:.72rem;background:#fef2f2;color:#dc2626;border:1px solid #fecaca">
                                            Retract
                                        </button>
                                    </form>
                                </div>
                                ...
                                <div class="mt-2 text-secondary" style="font-size:.72rem">
                                    Under investigation, so this report can no longer be edited or retracted.
                                </div>
                                @endif
