            ...
            <table class="table table-hover align-middle mb-0" style="font-size:.82rem">
                <thead style="background:#f9fafb;border-bottom:1px solid #e5e7eb">
                    <tr>
                        ...
                        <th class="fw-bold text-uppercase text-center pe-4 d-none d-lg-table-cell" style="font-size:.68rem;letter-spacing:.06em;color:#9ca3af;width:90px">Consistency</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-none d-lg-table-cell text-center pe-4" style="font-size:.78rem">
