                    ...
                    <div class="row g-3">
                        <div class="col-sm-6">
                            ...
                            <select name="duration_key" class="form-select @error('duration_key') is-invalid @enderror">
                                ...
                                <option value="30+"  {{ old('duration_key', $race->duration_key) === '30+'  ? 'selected' : '' }}>30 min championship — 1.2×</option>
                                <option value="30++" {{ old('duration_key', $race->duration_key) === '30++' ? 'selected' : '' }}>30 min endurance — 1.3×</option>
