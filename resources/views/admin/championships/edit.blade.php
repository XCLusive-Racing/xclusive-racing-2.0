            ...
            <div class="admin-card mb-4">
                <div class="px-4 pt-4 pb-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-4">
                            <label class="form-label">Max Missed Rounds</label>
                        ...
                        <div class="col-sm-4">
                            <label class="form-label">Min Rounds to Qualify</label>
                            <input type="number" name="min_rounds_to_qualify"
                                   value="{{ old('min_rounds_to_qualify', $championship->min_rounds_to_qualify) }}"
