                    ...
                    <div class="row g-3">
                        <div class="col-sm-6">
                            ...
                            <select name="game" class="form-select @error('game') is-invalid @enderror">
                                <option value="acc" {{ old('game', $server->game) === 'acc' ? 'selected' : '' }}>ACC</option>
                                <option value="lmu" {{ old('game', $server->game) === 'lmu' ? 'selected' : '' }}>Le Mans Ultimate</option>
                            </select>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="platform" class="form-select @error('platform') is-invalid @enderror">
                                <option value="console" {{ old('platform', $server->platform) === 'console' ? 'selected' : '' }}>Console</option>
                                <option value="pc" {{ old('platform', $server->platform) === 'pc' ? 'selected' : '' }}>PC</option>
                                <option value="cross" {{ old('platform', $server->platform) === 'cross' ? 'selected' : '' }}>Crossplay</option>
                            </select>
