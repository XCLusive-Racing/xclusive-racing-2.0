...
@section('title', 'Reset Password - XCLusive Racing')
...
<div class="xcl-auth-page py-5">
    ...
    <div class="xcl-auth-card">
        ...
        <div class="text-center mb-4">
            ...
            <h1 class="fs-3 fw-black text-uppercase fst-italic text-white mb-1">Reset Password</h1>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-3">
                <label class="form-label small fw-bold text-uppercase text-white-50 mb-1">New Password</label>
