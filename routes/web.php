...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/racing-teams/{team}/members/{user}/role', [RacingTeamController::class, 'updateMemberRole'])->name('racing-teams.members.role');
...
Route::middleware(['auth', 'league.access'])->prefix('admin/leagues')->name('admin.leagues.')->group(function () {
    ...
    Route::get('/{league}/servers/{server}/edit', [LeagueController::class, 'editServer'])->name('servers.edit')->withTrashed();
    Route::put('/{league}/servers/{server}', [LeagueController::class, 'updateServer'])->name('servers.update')->withTrashed();
